<?php 
	...
	function getAllNewsbyMainCategory($category,$kon,$start,$end)
	{
		$get="SELECT 
				...
				kategori_berita.kategori_seo as seo_kategori,   
				...
				AND berita.id_kategori_berita='$category'
	...
	function getMainCategory($kon)
	{
		...
		kategori_utama.seo_kategori_utama as seo_kategori_utama,
		...
		while ($c=mysqli_fetch_array($sql_get)) {
		    array_push($result,array(
		    	...
		    	'seo_kategori_utama'=>$c['seo_kategori_utama'])
		     );
		}
		return $result;
	}
